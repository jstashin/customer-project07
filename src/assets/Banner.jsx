...
const Banner = ({ inProgress, resolved}) => {
  return (
    <div className="flex flex-col md:flex-row gap-10 w-full justify-center items-center mt-5 mb-5">
     <div
        className="relative rounded-lg shadow-md  w-130 h-50 flex flex-col items-center justify-center overflow-hidden"
        style={{
          background:"linear-gradient(#ffffff90,#FCB7000),url('/vector1.png')"
        }}
         >
